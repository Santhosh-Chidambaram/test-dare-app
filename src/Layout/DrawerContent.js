    ...
    return(
        <View style={styles.container}>
                ...
                <View>
                    <View style={styles.header}>
                        <TouchableOpacity onPress={() => {
                            ...
                            <Avatar.Image  source={{uri:pic_url}} size={80} style={{backgroundColor:'#cecece'}}/>
                        </TouchableOpacity>
                    ...
                    <Drawer.Item 
                    active={active == '1'}
                    icon={() => <Icon type="material-community" name="home" size={35} color="#8e2de2"/>}
                    label="Home"
            ...
            <Drawer.Section style={styles.bottomDrawerSection}>
                <DrawerItem
                icon={() => <Icon type="material-community" name='exit-to-app' color='red' size={28}/>}
                label='Exit App'
